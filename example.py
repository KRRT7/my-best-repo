...
class GCodeProcessor:
    ...
    def interpolate_with_constant_resolution_XY(
        ...
        # Precompute values used in the loop
        dx_norm, dy_norm = (dx, dy) if (dx == 0 and dy == 0) else (dx / original_distance, dy / original_distance)
        ...
        for i in range(num_points + 1):
            ...
            # Store the delta E for all points except the first one
            if i > 0:
                e_delta = e - last_e
