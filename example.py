...
class GCodeProcessor:
    ...
    def interpolate_with_constant_resolution_XY(
        ...
        for i in range(num_points + 1):
            ...
            if 0 < i < num_points and segment_length > 0:
            ...
            # Store absolute E for the first point, delta E for others
            if i == 0:
                points.append((x, y, start_z, e))
            else:
                e_delta = e - last_e
                points.append((x, y, start_z, e_delta))
