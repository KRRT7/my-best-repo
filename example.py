...
class GCodeProcessor:
    ...
    def interpolate_with_constant_resolution_XY(
        ...
        # Pre-calculate differences and their length
        ...
        if length > 0:
            dx_per_length = dx / length
            dy_per_length = dy / length
        ...
        for i in range(num_points + 1):
            ...
            if 0 < i < num_points and length > 0:
                ...
                x += wobble * (-dy_per_length)
                y += wobble * dx_per_length
            ...
            # Append tuples with correct extrusion
            if i > 0:
                e_delta = e - last_e
